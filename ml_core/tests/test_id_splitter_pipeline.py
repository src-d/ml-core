...
class IdSplitterPipelineTest(unittest.TestCase):
    ...
    def test_binarize(self):
        from ml_core.algorithms.id_splitter.pipeline import binarize
    ...
    def test_prepare_devices(self):
        from ml_core.algorithms.id_splitter.nn_model import prepare_devices
    ...
    def test_build_schedule(self):
        from ml_core.algorithms.id_splitter.pipeline import build_schedule
    ...
    def test_build_train_generator(self):
        from ml_core.algorithms.id_splitter.pipeline import build_train_generator
    ...
    def test_train_parameters(self):
        from ml_core.algorithms.id_splitter.pipeline import create_generator_params
    ...
    def test_config_keras(self):
        ...
        from ml_core.algorithms.id_splitter.pipeline import config_keras
    ...
    def test_prepare_callbacks(self):
        ...
        from ml_core.algorithms.id_splitter.pipeline import prepare_callbacks
