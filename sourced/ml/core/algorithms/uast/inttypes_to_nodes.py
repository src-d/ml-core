...
from sourced.ml.core.algorithms.uast.to_bag import Uast2BagThroughSingleScan
...
class Uast2QuantizedChildren(Uast2BagThroughSingleScan):
    ...
    # Somewhere before calling this keys are converted to int so it works with spark
